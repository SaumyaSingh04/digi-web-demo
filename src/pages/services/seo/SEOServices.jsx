...
const SEOVisual = () => (
  <svg viewBox="0 0 520 390" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: '100%', display: 'block' }}>
    ...
    {/* Bottom face */}
    <polygon points="100,310 260,360 420,310 260,260" fill="#1e3c28" />
    {/* Left face */}
    <polygon points="100,220 100,310 260,360 260,270" fill="#162e1e" />
    {/* Right face */}
    <polygon points="420,220 420,310 260,360 260,270" fill="#265234" />
    {/* Top face */}
    <polygon points="100,220 260,270 420,220 260,170" fill="#2e6040" />
    ...
    <g filter="url(#seo-shadow)" transform="translate(60,40)">
      ...
      <rect x="16" y="14" width="80" height="7" rx="3" fill="#2a6040" />
      <rect x="16" y="26" width="50" height="5" rx="2" fill="#1e4830" />
      {/* bars */}
      ...
      <polyline points="21,107 37,99 53,102 69,93 85,96 101,87 117,90 133,81 149,84 165,74 181,66 197,62"
        stroke="#4ade80" strokeWidth="2" fill="none" strokeLinecap="round" opacity="0.7" />
      {/* badge */}
      <rect x="154" y="12" width="50" height="18" rx="7" fill="#16a34a" />
      <text x="163" y="25" fontSize="9" fill="#dcfce7" fontFamily="Inter,sans-serif" fontWeight="800">+182%</text>
    </g>
    ...
    <g filter="url(#seo-shadow)" transform="translate(240,80)">
      ...
      {[['SEO Services','#1'],['Local SEO','#2'],['Technical SEO','#1'],['Link Building','#3']].map(([kw,rank],i)=>(
        <g key={kw}>
          <rect x="16" y={34+i*26} width="120" height="7" rx="3" fill="#1e4030" />
          <rect x="156" y={30+i*26} width="34" height="16" rx="6"
            fill={rank==='#1'?'#16a34a':rank==='#2'?'#22c55e':'#4ade80'} opacity="0.8" />
          <text x={rank==='#1'?163:162} y={42+i*26} fontSize="8" fill="#dcfce7"
    ...
    <g filter="url(#seo-shadow)" transform="translate(130,200)">
      ...
      <circle cx="65" cy="65" r="38" stroke="#1e4030" strokeWidth="7" fill="none" />
      <circle cx="65" cy="65" r="38" stroke="#4ade80" strokeWidth="7" fill="none"
        strokeDasharray="190" strokeDashoffset="48" strokeLinecap="round"
        transform="rotate(-90 65 65)" opacity="0.85" />
      <text x="65" y="62" fontSize="18" fontWeight="900" fill="#bbf7d0"
        fontFamily="Inter,sans-serif" textAnchor="middle">94</text>
      <text x="65" y="76" fontSize="7" fill="#4ade80"
    ...
    <g filter="url(#seo-shadow-sm)" transform="translate(58,200)">
      ...
      <text x="29" y="20" fontSize="7" fill="#4ade80" fontFamily="Inter,sans-serif" textAnchor="middle">Domain</text>
      <text x="29" y="34" fontSize="12" fontWeight="900" fill="#bbf7d0" fontFamily="Inter,sans-serif" textAnchor="middle">68</text>
    </g>
    <g filter="url(#seo-shadow-sm)" transform="translate(58,255)">
      <rect width="58" height="44" rx="10" fill="url(#seo-dark)" />
      <text x="29" y="20" fontSize="7" fill="#4ade80" fontFamily="Inter,sans-serif" textAnchor="middle">Links</text>
      <text x="29" y="34" fontSize="12" fontWeight="900" fill="#bbf7d0" fontFamily="Inter,sans-serif" textAnchor="middle">3.2k</text>
    </g>
  </svg>
)
