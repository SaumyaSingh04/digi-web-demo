...
const SMMVisual = () => (
  <svg viewBox="0 0 480 360" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: '100%', display: 'block' }}>
    ...
    {/* Feed post 1 */}
    <rect x="152" y="72" width="64" height="66" rx="3" fill="#1a0a30" />
    <circle cx="162" cy="82" r="6" fill="#3a1a50" />
    <rect x="172" y="78" width="34" height="4" rx="2" fill="#3a1a50" />
    <rect x="172" y="85" width="24" height="3" rx="1" fill="#2a1040" />
    <rect x="152" y="94" width="64" height="32" rx="2" fill="#2a1040" />
    <rect x="156" y="130" width="16" height="4" rx="2" fill="#2a1040" />
    <rect x="178" y="130" width="16" height="4" rx="2" fill="#2a1040" />

    {/* Feed post 2 */}
    <rect x="152" y="144" width="64" height="66" rx="3" fill="#1a0a30" />
    <circle cx="162" cy="154" r="6" fill="#4a2060" />
    <rect x="172" y="150" width="34" height="4" rx="2" fill="#3a1a50" />
    <rect x="172" y="157" width="24" height="3" rx="1" fill="#2a1040" />
    <rect x="152" y="166" width="64" height="30" rx="2" fill="#3a1a50" />
    <rect x="156" y="202" width="16" height="4" rx="2" fill="#2a1040" />

    {/* Feed post 3 */}
    <rect x="152" y="216" width="64" height="50" rx="3" fill="#1a0a30" />
    <circle cx="162" cy="226" r="6" fill="#3a1858" />
    <rect x="172" y="222" width="34" height="4" rx="2" fill="#3a1a50" />
    <rect x="152" y="234" width="64" height="22" rx="2" fill="#2a1450" />

    {/* ── Floating analytics card ── */}
    <g filter="url(#smm-shadow)" transform="translate(250,30)">
      <rect width="200" height="110" rx="14" fill="url(#smm-card)" />
      <polygon points="200,14 204,18 204,118 200,114" fill="#2a1040" />
      <polygon points="14,110 18,114 204,114 200,110" fill="#1e0a30" />
      <rect x="16" y="14" width="80" height="6" rx="3" fill="#6a40a0" />
      <text x="152" y="30" fontSize="11" fill="#c0a0e8" fontFamily="Inter,sans-serif" fontWeight="800">+210%</text>
      {/* sparkline */}
      ...
      <polyline points="16,96 36,88 56,84 76,72 96,64 116,54 136,44 156,36 176,28 196,22 196,96"
        fill="#9060c8" opacity="0.1" />
    </g>

    {/* ── Engagement card ── */}
    <g filter="url(#smm-shadow)" transform="translate(250,155)">
      <rect width="92" height="72" rx="12" fill="url(#smm-dark)" />
      <polygon points="92,12 96,16 96,80 92,76" fill="#100228" />
      <polygon points="12,72 16,76 96,76 92,72" fill="#0a021e" />
      <rect x="12" y="12" width="50" height="5" rx="2" fill="#7050a8" />
      <text x="12" y="50" fontSize="22" fontWeight="900" fill="#d0b0f0" fontFamily="Inter,sans-serif">3.8x</text>
      <rect x="12" y="56" width="60" height="4" rx="2" fill="#c0a0e8" />
    </g>

    {/* ── Platform icons card ── */}
    <g filter="url(#smm-shadow)" transform="translate(354,155)">
      <rect width="96" height="72" rx="12" fill="url(#smm-dark)" />
      <polygon points="96,12 100,16 100,80 96,76" fill="#100228" />
      <polygon points="12,72 16,76 100,76 96,72" fill="#0a021e" />
      <rect x="12" y="12" width="50" height="5" rx="2" fill="#7050a8" />
      <text x="12" y="50" fontSize="22" fontWeight="900" fill="#d0b0f0" fontFamily="Inter,sans-serif">8+</text>
      <rect x="12" y="56" width="60" height="4" rx="2" fill="#c0a0e8" />
    </g>
    ...
    <g filter="url(#smm-shadow)" transform="translate(250,242)">
      ...
      <polygon points="200,12 204,16 204,56 200,52" fill="#2a1040" />
      <polygon points="12,48 16,52 204,52 200,48" fill="#1e0a30" />
      <rect x="12" y="12" width="50" height="5" rx="2" fill="#8A8EA8" />
      {['IG','FB','LI','TK','YT'].map((l,i)=>(
        <g key={l}>
          <circle cx={24+i*36} cy={34} r={12} fill="#3a1858" />
          <text x={18+i*36} y={38} fontSize="7" fill="#c0a0e0"
