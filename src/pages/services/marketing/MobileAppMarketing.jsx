...
const AppMarketingVisual = () => (
  <svg viewBox="0 0 480 360" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: '100%', display: 'block' }}>
    ...
    <g filter="url(#am-shadow)" transform="translate(24,24)">
      ...
      <polygon points="200,14 204,18 204,192 200,188" fill="#040a18" />
      <polygon points="14,180 18,184 204,184 200,180" fill="#020610" />
      {/* App icon */}
      <rect x="14" y="14" width="50" height="50" rx="12" fill="#0a1428" />
      <text x="39" y="46" fontSize="22" fontFamily="Inter,sans-serif" textAnchor="middle">🚀</text>
      <rect x="74" y="18" width="80" height="7" rx="3" fill="#3a5888" />
      <rect x="74" y="30" width="60" height="5" rx="2" fill="#2a4878" />
      {/* Rating */}
      <text x="74" y="52" fontSize="12" fill="#c8a040" fontFamily="Inter,sans-serif">★★★★★</text>
      <rect x="74" y="56" width="40" height="4" rx="2" fill="#2a4878" />
      <rect x="14" y="72" width="172" height="1" fill="#303850" />
      {/* Stats */}
      <rect x="14" y="80" width="70" height="5" rx="2" fill="#3a5888" />
      {[['Downloads','+300%'],['ROAS','4.2x'],['D-30 Retention','+60%']].map(([l,v],i)=>(
        <g key={l}>
          <rect x="14" y={94+i*26} width="172" height="20" rx="5" fill="#0a1428" />
          <text x="20" y={108+i*26} fontSize="8" fill="#5080b8" fontFamily="Inter,sans-serif">{l}</text>
          <text x="174" y={108+i*26} fontSize="9" fontWeight="800" fill="#80b0d8" fontFamily="Inter,sans-serif" textAnchor="end">{v}</text>
        </g>
      ))}
    </g>
    ...
    <g filter="url(#am-shadow)" transform="translate(240,24)">
      ...
      <polygon points="216,14 220,18 220,118 216,114" fill="#c0d4f0" />
      <polygon points="14,110 18,114 220,114 216,110" fill="#b0c8e8" />
      <rect x="14" y="14" width="80" height="5" rx="2" fill="#6890c0" />
      <text x="170" y="30" fontSize="11" fontWeight="900" fill="#0a1020" fontFamily="Inter,sans-serif">+300%</text>
      {[18,28,22,40,34,56,48,66,60,78,88,100].map((h,i)=>(
        <rect key={i} x={14+i*16} y={96-h*0.66} width={11} height={h*0.66} rx="2"
          fill={i>=9?'#5080a8':i>=6?'#5080b8':'#9098C0'} />
      ))}
    </g>
    ...
    <g filter="url(#am-shadow)" transform="translate(240,148)">
      ...
      <polygon points="216,14 220,18 220,88 216,84" fill="#040a18" />
      <polygon points="14,80 18,84 220,84 216,80" fill="#020610" />
      <rect x="14" y="14" width="70" height="5" rx="2" fill="#3a5888" />
      {[['App Store','Top 10'],['Google Play','Top 10'],['CPI','Optimised']].map(([l,v],i)=>(
        <g key={l}>
          <text x={14+i*68} y="38" fontSize="7" fill="#5080b8" fontFamily="Inter,sans-serif">{l}</text>
          <text x={14+i*68} y="58" fontSize="12" fontWeight="900" fill="#90b8e0" fontFamily="Inter,sans-serif">{v}</text>
    ...
    <g filter="url(#am-shadow)" transform="translate(24,220)">
      ...
      <polygon points="432,12 436,16 436,64 432,60" fill="#c0d4f0" />
      <polygon points="12,56 16,60 436,60 432,56" fill="#b0c8e8" />
      <rect x="12" y="12" width="70" height="4" rx="2" fill="#6890c0" />
      {['Google UAC','Apple Search','Meta Ads','TikTok','Programmatic'].map((p,i)=>(
        <g key={p}>
          <rect x={12+i*86} y={22} width={76} height={22} rx="7" fill="#1e3060" />
          <text x={50+i*86} y={37} fontSize="8" fill="#5080a8" fontFamily="Inter,sans-serif" fontWeight="600" textAnchor="middle">{p}</text>
        </g>
      ))}
    </g>
    ...
    <g filter="url(#am-shadow)" transform="translate(24,290)">
      ...
      <polygon points="200,10 204,14 204,52 200,48" fill="#040a18" />
      <polygon points="10,46 14,50 204,50 200,46" fill="#020610" />
      <text x="14" y="22" fontSize="7" fill="#3a5888" fontFamily="Inter,sans-serif">Day-30 Retention Lift</text>
      <text x="14" y="40" fontSize="16" fontWeight="900" fill="#80b0d8" fontFamily="Inter,sans-serif">+60% retained users</text>
    </g>
  </svg>
)
