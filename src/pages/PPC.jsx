...
const PPCVisual = () => (
  <svg viewBox="0 0 480 360" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: '100%', display: 'block' }}>
    ...
    <polygon points="40,290 240,330 440,290 240,250" fill="#2a1060" />
    <polygon points="40,240 40,290 240,330 240,280" fill="#1e0850" />
    <polygon points="440,240 440,290 240,330 240,280" fill="#341470" />

    {/* ── ROAS big card ── */}
    <g filter="url(#ppc-shadow)" transform="translate(30,30)">
      <rect width="170" height="90" rx="14" fill="url(#ppc-dark)" />
      <polygon points="170,14 174,18 174,98 170,94" fill="#0c0418" />
      <polygon points="14,90 18,94 174,94 170,90" fill="#080210" />
      <rect x="16" y="14" width="60" height="6" rx="3" fill="#8060a8" />
      <text x="16" y="62" fontSize="30" fontWeight="900" fill="#d0b8f0" fontFamily="Inter,sans-serif">4.5x</text>
      <rect x="16" y="70" width="50" height="5" rx="2" fill="#604898" />
      <rect x="118" y="12" width="36" height="14" rx="6" fill="#604898" />
      <text x="124" y="23" fontSize="8" fill="#b090e0" fontFamily="Inter,sans-serif" fontWeight="700">+38%</text>
    </g>

    {/* ── CPA card ── */}
    <g filter="url(#ppc-shadow)" transform="translate(212,30)">
      <rect width="120" height="90" rx="14" fill="url(#ppc-card)" />
      <polygon points="120,14 124,18 124,98 120,94" fill="#1a0e38" />
      <polygon points="14,90 18,94 124,94 120,90" fill="#140a2e" />
      <rect x="14" y="14" width="55" height="6" rx="3" fill="#7060a0" />
      <text x="14" y="62" fontSize="22" fontWeight="900" fill="#160824" fontFamily="Inter,sans-serif">$12.4</text>
      <rect x="14" y="70" width="60" height="4" rx="2" fill="#6050908" />
    </g>

    {/* ── Spend card ── */}
    <g filter="url(#ppc-shadow)" transform="translate(344,30)">
      <rect width="106" height="90" rx="14" fill="url(#ppc-card)" />
      <polygon points="106,14 110,18 110,98 106,94" fill="#1a0e38" />
      <polygon points="14,90 18,94 110,94 106,90" fill="#140a2e" />
      <rect x="14" y="14" width="55" height="6" rx="3" fill="#7060a0" />
      <text x="14" y="62" fontSize="18" fontWeight="900" fill="#160824" fontFamily="Inter,sans-serif">$2M+</text>
      <rect x="14" y="70" width="48" height="4" rx="2" fill="#6050908" />
    </g>

    {/* ── Campaign chart ── */}
    <g filter="url(#ppc-shadow)" transform="translate(30,138)">
      <rect width="270" height="130" rx="14" fill="url(#ppc-card)" />
      <polygon points="270,14 274,18 274,142 270,138" fill="#1a0e38" />
      <polygon points="14,130 18,134 274,134 270,130" fill="#140a2e" />
      ...
      {[30,50,42,65,58,80,72,90,85,100].map((h,i)=>(
        <rect key={i} x={16+i*24} y={118-h*0.82} width="16" rx="3"
          height={h*0.82}
          fill={i>=7?'#160824':i>=5?'#9070c0':'#b090e0'} />
      ))}
    </g>
    ...
    <g filter="url(#ppc-shadow)" transform="translate(312,138)">
      ...
      <polygon points="138,14 142,18 142,142 138,138" fill="#0c0418" />
      <polygon points="14,130 18,134 142,134 138,130" fill="#080210" />
      <rect x="14" y="14" width="60" height="6" rx="3" fill="#8060a8" />
      {[['Google',52,'#1a0e38'],['Meta',30,'#A8A098'],['LinkedIn',18,'#787068']].map(([nm,pct,clr],i)=>(
        <g key={nm}>
