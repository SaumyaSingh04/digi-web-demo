...
const megaMenuData = [
  ...
  },
  {
    ...
    services: [
      ...
      { label: 'Mobile Apps Development', to: '/services/mobile-apps-development' },
      { label: 'Ecommerce Development', to: '/services/ecommerce-web-development' },
      { label: 'WordPress Development', to: '/services/wordpress-development' },
      { label: 'ReactJS Development', to: '/services/reactjs-development' },
      { label: 'Node.js Development', to: '/services/nodejs-development' },
      { label: 'PHP Development', to: '/services/php-development' },
      { label: 'AngularJS Development', to: '/services/angularjs-development' },
      { label: 'ASP.NET Development', to: '/services/asp-net-development' },
      { label: 'CRM Solutions', to: '/services/crm-solutions' },
    ],
    card: {
