...
const megaMenuData = [
  ...
  },
  {
    ...
    services: [
      ...
      { label: 'AI Content Generation', to: '/services' },
      { label: 'Predictive Analytics', to: '/services' },
      { label: 'CRM Automation', to: '/services' },
      { label: 'Lead Scoring AI', to: '/services' },
      { label: 'Smart Reporting', to: '/services' },
      { label: 'AI SEO Tools', to: '/services' },
      { label: 'Voice Search Optimisation', to: '/services' },
    ],
    card: {
